...
const out=new URL('./iteration07/',import.meta.url).pathname.replace(/^\/(\w:)/,'$1');
...
try {
 ...
 for(const [kind,w,h] of [['desktop',1438,666],['mobile',388,620]]) {
  ...
  await s.cdp('Page.navigate',{url:'file:///C:/dev/gridalpha-v2-nivar-g2/docs/g2-dream-build/g2-2/hero/iteration07/hero-'+kind+'.mp4'});
