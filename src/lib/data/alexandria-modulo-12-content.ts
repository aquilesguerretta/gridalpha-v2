...
export const INSTRUMENTOS_MODULO_12: Instrument[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
      id: "mp-v-i1",
      label: "Contrato de compra de energia — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      ...
      {
      id: "mp-v-i2",
      label: "Comprador contratado — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i3",
      label: "Financiamento e decisão final de investimento — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i4",
      label: "Licenciamento ambiental — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i5",
      label: "Acesso e conexão à rede — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i6",
      label: "Terreno e direito de uso — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i7",
      label: "Maturidade de engenharia — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i8",
      label: "Fornecimento de equipamento principal — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
      ...
      {
      id: "mp-v-i9",
      label: "Habilitação a regime de incentivo — presente",
      unit: null,
      kind: "select",
      defaultValue: "nao",
      options: [{ value: "nao", label: "Não" }, { value: "sim", label: "Sim" }],
