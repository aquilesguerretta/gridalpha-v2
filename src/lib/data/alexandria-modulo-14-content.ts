...
export const MODULO_14_CORPO: Record<string, AulaBloco[]> = {
  'aula-14-01': [
    ...
    { kind: 'formula', eq: "Custo/km = Preço por litro ÷ Rendimento em km por litro", desc: "A única comparação que decide. O combustível mais barato <b>por litro</b> pode ser mais caro <b>por quilômetro</b>, e é exatamente isso que a regra dos 70% esconde quando aplicada a um veículo cuja razão de eficiência real não é 0,70." },
    { kind: 'titulo', numero: null, texto: "Índice de paridade — triagem, não decisão" },
    { kind: 'formula', eq: "Índice = Preço do hidratado ÷ Preço da gasolina C", desc: "Serve para uma triagem de dez segundos. A decisão só sai da comparação entre esse índice e a <b>razão real de rendimento</b> do veículo — não contra 0,70, que é um número herdado e não medido." },
  ...
  'aula-14-02': [
    ...
    { kind: 'formula', eq: "ATR total = Cana moída (t) × ATR médio (kg/t)", desc: "Converta as unidades antes de comparar. Três milhões de toneladas a 138 kg de ATR por tonelada equivalem a 414 milhões de quilos de ATR <b>antes</b> de perdas industriais e de conversão — e é sobre esse número, não sobre a tonelagem, que a decisão de mix incide." },
    { kind: 'titulo', numero: null, texto: "Produtividade agrícola" },
    { kind: 'formula', eq: "TCH = Cana colhida (t) ÷ Área colhida (ha)", desc: "Toneladas de cana por hectare. Precisa ser lida <b>junto</b> com o ATR e com a idade média do canavial: TCH alto com ATR baixo e canavial velho descreve uma situação completamente diferente de TCH médio com ATR alto e canavial renovado." },
  ...
  'aula-14-07': [
    ...
    { kind: 'formula', eq: "Créditos ≈ Volume × Densidade energética × (IC fóssil − IC da rota) ÷ 10⁶", desc: "Com volume em litros, densidade energética em MJ por litro e intensidades em gramas de CO₂ equivalente por MJ, a divisão por um milhão converte gramas em toneladas. <b>A fórmula exata, os fatores de elegibilidade e os arredondamentos seguem a regra da agência</b> — esta expressão existe para ensinar de onde vem a ordem de grandeza, não para substituir o cálculo oficial nem para ser citada como método." },
